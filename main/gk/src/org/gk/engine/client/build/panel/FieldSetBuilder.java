...
public class FieldSetBuilder extends Builder {

	public FieldSetBuilder(String processNodeName) {
	...
	public void processNode(List<UIGen> nodeList, Node node) {
		...
		// 建構XFieldSet
		XFieldSet fieldSet = new XFieldSet(node, subNodes);
		nodeList.add(fieldSet);
	}
}
