...
public class ContentPanelBuilder extends Builder {

	public ContentPanelBuilder(String nodeName) {
		super(nodeName);
	}
	...
	public void processNode(List<UIGen> nodeList, Node node) {
		...
		// 建構XContentPanel
		XContentPanel contentPanel = new XContentPanel(node, subNodes);
		nodeList.add(contentPanel);
	}
}
