...
/**
 * BoxLayoutData Builder
 * 
 * @author i23250
 * @since 2012/1/10
 */
public class BoxLayoutDataBuilder extends Builder {

	public BoxLayoutDataBuilder(String processNodeName) {
	...
	public void processNode(List<UIGen> nodeList, Node node) {
		...
		// 建構XBoxLayoutData
		XBoxLayoutData box = new XBoxLayoutData(node, subNodes);
		nodeList.add(box);
	}
}
