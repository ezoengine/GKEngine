...
import org.gk.ui.client.com.grid.column.gkLabelColumnConfig;

import com.extjs.gxt.ui.client.widget.form.Field;
import com.extjs.gxt.ui.client.widget.grid.ColumnConfig;

public class GLabelFieldBuilder extends GridFieldBuilder {

	public GLabelFieldBuilder(String label) {
		super(label);
	}
	...
	public ColumnConfig create() {
		...
		x.setCellEditor("false"); // LabelField不需要CellEditor
		ColumnConfig cc = new gkLabelColumnConfig(x) {
			@Override
