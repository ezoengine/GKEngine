...
public class MenuBarBuilder extends Builder {

	public MenuBarBuilder(String processNodeName) {
	...
	public void processNode(List<UIGen> nodeList, Node node) {
		...
		XMenuBar xMenuBar = new XMenuBar(node, subNodes);
		nodeList.add(xMenuBar);
	}
}
