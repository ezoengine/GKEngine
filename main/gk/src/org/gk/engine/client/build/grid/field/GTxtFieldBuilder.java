...
import org.gk.ui.client.com.grid.column.gkTextColumnConfig;

import com.extjs.gxt.ui.client.widget.form.Field;
import com.extjs.gxt.ui.client.widget.grid.ColumnConfig;

public class GTxtFieldBuilder extends GridFieldBuilder {

	public GTxtFieldBuilder(String txt) {
		super(txt);
	}
	...
	public ColumnConfig create() {
		...
		ColumnConfig cc = new gkTextColumnConfig(x) {
			@Override
