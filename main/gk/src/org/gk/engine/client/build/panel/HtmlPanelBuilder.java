...
public class HtmlPanelBuilder extends Builder {

	public HtmlPanelBuilder(String processNodeName) {
	...
	public void processNode(List<UIGen> nodeList, Node node) {
		// 建構XHtmlPanel
		XHtmlPanel htmlPanel = new XHtmlPanel(node);
		nodeList.add(htmlPanel);
	}
}
