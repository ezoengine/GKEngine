...
import org.gk.ui.client.com.grid.column.gkTextAreaColumnConfig;

import com.extjs.gxt.ui.client.widget.form.Field;
import com.extjs.gxt.ui.client.widget.grid.ColumnConfig;

public class GTextAreaBuilder extends GridFieldBuilder {

	public GTextAreaBuilder(String textarea) {
		super(textarea);
	}
	...
	public ColumnConfig create() {
		...
		ColumnConfig cc = new gkTextAreaColumnConfig(x) {
			@Override
