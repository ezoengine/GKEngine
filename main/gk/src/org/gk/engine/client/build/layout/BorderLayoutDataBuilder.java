...
/**
 * BorderLayoutData Builder
 * 
 * @author i23250
 * @since 2012/1/10
 */
public class BorderLayoutDataBuilder extends Builder {

	public BorderLayoutDataBuilder(String processNodeName) {
	...
	public void processNode(List<UIGen> nodeList, Node node) {
		...
		// 建構XBorderLayoutData
		XBorderLayoutData border = new XBorderLayoutData(node, subNodes);
		nodeList.add(border);
	}
}
